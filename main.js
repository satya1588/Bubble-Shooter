...
window.onload = function() {
    ...
    function render() {
        ...
        if (gamestate == gamestates.gameover) {
            ...
            drawCenterText("Press Ok to start", level.x, level.y + level.height / 2 + 40, level.width);
        }
    }
    ...
    function drawFrame() {
        ...
        let hg=localStorage.getItem('highScore') || 0;
        context.fillText("Bubble-shooter                         High Score: "+hg, 8, 37);
        context.fillText("Bubble-shooter", 10, 36);
    ...
    function onKeyDown(e) {
        ...
        // Handle arrow keys for adjusting cannon direction
